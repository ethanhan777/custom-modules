...
export const authorEventsPageSelector = 'author-events-page';

@Component({
  selector: authorEventsPageSelector,
  templateUrl: './author-events-page.component.html',
})
@Injectable()
export class AuthorEventsPageComponent implements OnInit, OnDestroy {
  author: any;
  ...
  sendTealiumData(author) {
    this.tealium.track('view', {
      'page_type': 'events-by-author',
      'page_name': author.display + ' Events',
